...
const heroSlides = [
	{
		...
		description:
			"Serving UE Manila students with excellence, integrity, and dedication.",
	...
	},
	{
		...
		description:
			"Have a concern or suggestion? Let us know and we'll work to address it.",
		image: "/images/ue-red-warrior.jpeg",
	...
	},
	{
		...
		description:
			"Stay updated with the latest events and activities organized by USC.",
		image: "/images/ue-red-warrior.jpeg",
				...
				<div className="max-w-7xl mx-auto">
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
						...
						>
							...
							<p className="text-gray-600 mb-4">
								Share your concerns and suggestions with us
							</p>
							<span className="text-red-600 font-semibold inline-flex items-center">
						...
						>
							...
							<p className="text-gray-600 mb-4">
								Meet your student council officers and committees
							</p>
							<span className="text-red-600 font-semibold inline-flex items-center">
			...
			<section className="section-padding bg-red-100 shadow-lg">
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-12">
						...
						<p className="text-xl text-gray-600">
							Access essential UE platforms for students
						</p>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						<Link
							target="_blank"
							href="https://ue.instructure.com/login/canvas"
							className="card p-8 text-center hover:scale-105 transition-transform"
						>
							<MessageSquare className="h-16 w-16 text-red-600 mx-auto mb-4" />
							<h3 className="text-xl font-semibold mb-2">UE Canvas</h3>
							<p className="text-gray-600 mb-4">
								Access your online learning platform
							</p>
							<span className="text-red-600 font-semibold inline-flex items-center">
						...
						<Link
							target="_blank"
							href="https://apps.ue.edu.ph/portals/sp/"
							className="card p-8 text-center hover:scale-105 transition-transform"
						>
							<Users className="h-16 w-16 text-red-600 mx-auto mb-4" />
							<h3 className="text-xl font-semibold mb-2">UE Portal</h3>
							<p className="text-gray-600 mb-4">
								Manage your student account and services
							</p>
							<span className="text-red-600 font-semibold inline-flex items-center">
						...
						<Link
							target="_blank"
							href="https://www.ue.edu.ph/mla/"
							className="card p-8 text-center hover:scale-105 transition-transform"
						>
							<Users className="h-16 w-16 text-red-600 mx-auto mb-4" />
							<h3 className="text-xl font-semibold mb-2">UE Website</h3>
							<p className="text-gray-600 mb-4">
								Access the official University Website
							</p>
							<span className="text-red-600 font-semibold inline-flex items-center">
						...
						<Link
							target="_blank"
							href="https://apps.ue.edu.ph/iEnroll/login.html"
							className="card p-8 text-center hover:scale-105 transition-transform"
						>
							<Users className="h-16 w-16 text-red-600 mx-auto mb-4" />
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						{[
							...
							},
							{
								...
								category: "Events",
								excerpt:
									"Join us for a week-long series of activities focused on mental health and wellness.",
							},
							{
								...
								category: "Services",
								excerpt:
									"We've launched new services to better support our student community.",
							},
						]
							.slice(0, 3)
							.map((announcement, index) => (
								<div key={index} className="card p-6">
									...
									<Link
										href="/announcements"
										className="text-red-600 font-semibold inline-flex items-center"
									>
										Read More{" "}
										<ChevronRight className="ml-1 h-4 w-4" />
									</Link>
